...
#ifdef CONFIG_VOLTAGE
#define CPU_MILLIVOLTS_VOLT {\
    800, 825, 850, 875, 900, 916, 950, 975, 1000, 1007, 1025, 1050, 1075, 1100, 1125, 1150, 1170, 1174, 1177, 1181, 1184, 1187, 1191, 1194, 1197, 1201, 1205, 1208, 1211, 1215, 1218, 1221, 1225, 1228, 1231, 1234, 1237, 1239, 1241, 1243};
#endif
#define CPU_MILLIVOLTS {\
    800, 825, 850, 875, 900, 916, 950, 975, 1000, 1007, 1025, 1050, 1075, 1100, 1125, 1150, 1170, 1174, 1177, 1181, 1184, 1187, 1191, 1194, 1197, 1201, 1205, 1208, 1211, 1215, 1218, 1221, 1225, 1228, 1231, 1234, 1237, 1239, 1241, 1243};

#ifdef CONFIG_VOLTAGE
int user_mv_table[MAX_DVFS_FREQS] = CPU_MILLIVOLTS_VOLT;
#endif
...
static const int cpu_millivolts[MAX_DVFS_FREQS] = CPU_MILLIVOLTS;
...
#ifdef CONFIG_OC_CPU
	CPU_DVFS("cpu_g",  7, 0, MHZ, 500, 540, 650, 680,  700,  800,  880,  980, 1000, 1080, 1100, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700),
	CPU_DVFS("cpu_g",  7, 1, MHZ, 500, 540, 650, 680,  700,  800,  880,  980, 1000, 1080, 1100, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700),
	CPU_DVFS("cpu_g",  7, 2, MHZ, 500, 540, 650, 680,  700,  800,  880,  980, 1000, 1080, 1100, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700),
	CPU_DVFS("cpu_g",  7, 3, MHZ, 500, 540, 650, 680,  700,  800,  880,  980, 1000, 1080, 1100, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700),
	CPU_DVFS("cpu_g",  7, 4, MHZ, 500, 540, 650, 680,  700,  800,  880,  980, 1000, 1080, 1100, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700),
#else
...
#ifdef CONFIG_OC_CPU
	CORE_DVFS("emc",    1, 1, KHZ,   102000, 450000, 450000, 450000, 450000,  667000,  667000,  800000,  900000),
#else
...
#ifdef CONFIG_OC_CPU
	CORE_DVFS("sbus",   1, 1, KHZ,   102000, 205000, 205000, 227000, 227000,  267000,  334000,  334000,  334000),
#else
...
#ifdef CONFIG_OC_CPU
	CORE_DVFS("vi",     1, 1, KHZ,        1, 219000, 267000, 300000, 371000,  409000,  425000,  425000,  425000),
#else
...
#endif
#ifdef CONFIG_OC_GPU_520
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  446000,  484000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  416000,  446000,  484000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  446000,  484000,  520000),
#endif
#else
...
#endif
#ifdef CONFIG_OC_GPU_520
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  416000,  446000,  484000,  520000),
#endif
#else
